<?php
/**
 * This is the test page for FineUploader acceptance tests
 * @author James
 */
 ...
 */
class FineUploaderTestPage extends Page
{
    /**
     * Singular name for CMS
     * @var string
     */
    private static $singular_name = 'Test page for FineUploader file upload testing';

    /**
     * Plural name for CMS
     * @var string
     */
    private static $plural_name = 'Test pages for FineUploader file upload testing';
}

/**
 * Test Controller for handling acceptance test requests
 */
class FineUploaderTestPageController extends PageController
{
    ...
    {
        $upload_field = FineUploaderField::create('FineUploaderTestUploadField', 'FineUploader Upload Field');
    ...
    public function doAnUpload(array $data, Form $form)
    {
        try {
            ...
            $upload_field = $fields->dataFieldByName('FineUploaderTestUploadField');
            // get the field ID
